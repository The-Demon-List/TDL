    ...
    template: `
        ...
        <main v-else class="page-history" style="font-family: 'Lexend Deca', sans-serif; padding: 20px; max-width: 1200px; margin: 0 auto;">
            <div style="background: var(--background-card, #202225); padding: 25px; border-radius: 8px; margin-bottom: 30px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                <h1 style="margin: 0 0 10px 0; color: var(--font-color, #fff);">🕰️ Demon List Time Machine</h1>
            ...
            <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 20px;" class="history-layout">
                ...
                <div v-if="list[selected]" style="background: var(--background-card, #202225); border-radius: 8px; padding: 25px;">
                    <h2 style="font-size: 2.5rem; margin-top: 0; color: var(--font-color, #fff);">{{ list[selected].name }}</h2>
                    <p style="color: #b9bbbe;">Creator: <strong style="color: var(--font-color, #fff);">{{ list[selected].creator }}</strong></p>
                    <p style="color: #b9bbbe;">Verifier: <strong style="color: var(--font-color, #fff);">{{ list[selected].verifier }}</strong></p>
